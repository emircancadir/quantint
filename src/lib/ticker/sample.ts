...
export const SAMPLE_QUOTES: Quote[] = [
  ...
  { symbol: 'ETH/USD', price: '4.180', change: '+1,42%', up: true },
  { symbol: 'SOL/USD', price: '184,2', change: '−0,63%', up: false },
  { symbol: 'XRP/USD', price: '3,12', change: '+0,84%', up: true },
  { symbol: 'BNB/USD', price: '812,4', change: '+0,31%', up: true },
